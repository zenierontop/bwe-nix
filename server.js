...
var io = require('socket.io')(server, {
  cors: {
    origin: ["http://localhost:" + port + "", "http://127.0.0.1:" + port + "", "https://cobalt.cosmicstar37.repl.co:443","http://147.185.221.180:35473"],
    methods: ["GET", "POST"],
  },
  handlePreflightRequest: (req, res) => {
    const headers = {
      "Access-Control-Allow-Headers": "Content-Type, Authorization",
      "Access-Control-Allow-Origin": ["http://localhost:" + port + "", "http://127.0.0.1:" + port + "", "https://cobalt.cosmicstar37.repl.co:443","http://147.185.221.180:35473"],
      "Access-Control-Allow-Credentials": true,
    };
    if (headers["Access-Control-Allow-Origin"] != headers["Access-Control-Allow-Origin"][0] || headers["Access-Control-Allow-Origin"][1] || headers["Access-Control-Allow-Origin"][2] || headers["Access-Control-Allow-Origin"][3]) {
