                ...
                },
                {
                    ...
                    value: function (text, say, allowHtml) {
						...
						function getBonziHEXColor(color) {
							let hex="#AB47BC";
							if(color=="purple"){return"#AB47BC"}else if(color=="dark_purple"){return"#893797"}else if(color=="magenta"){return"#FF00FF"}else if(color=="pink"){return"#F43475"}else if(color=="blue"){return"#4668FF"}else if(color=="cyan"){return"#00ffff"}else if(color=="red"){return"#f44336"}else if(color=="dark_red"){return"#800000"}else if(color=="orange"){return"#FF4711"}else if(color=="green"){return"#4CAF50"}else if(color=="lime"){return"#55FF11"}else if(color=="lemon"){return"#AFF314"}else if(color=="yellow"){return"#F1E11E"}else if(color=="brown"){return"#795548"}else if(color=="black"){return"#424242"}else if(color=="grey"){return"#828282"}else if(color=="white"){return"#EAEAEA"}else if(color=="ghost"){return"#D77BE7"}else{return hex}
						}
