										...
										items: {
											...
											quote: {
												...
												callback: function () {
                                                    ...
                                                    $("#chat_message").val("<blockquote>" + _this2.last + "</blockquote> ").focus()
